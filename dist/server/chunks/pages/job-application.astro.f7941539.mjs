...
const $$JobApplication = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "job application", "class": "astro-IKEPWYPJ" }, { "default": ($$result2) => renderTemplate`
    ${maybeRenderHead($$result2)}<section class="job-container astro-IKEPWYPJ">
        <div class="con-col astro-IKEPWYPJ">
            ...
            <div class="right-col astro-IKEPWYPJ">
                ${renderComponent($$result2, "MultiStepForm", MultiStepForm, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/home/ampliz/Development/astro/BP/src/components/Form/MultiStepForm", "client:component-export": "default", "class": "astro-IKEPWYPJ" })}
            </div>
    
        </div>
    </section>
` })}`;
}, "/home/ampliz/Development/astro/BP/src/pages/en/job-application.astro");

const $$file = "/home/ampliz/Development/astro/BP/src/pages/en/job-application.astro";
