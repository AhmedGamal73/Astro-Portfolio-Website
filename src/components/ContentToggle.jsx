...
import RegistrationForm from "./Form/ContactForms/RegistrationForm";
import SuggestionForm from "./Form/ContactForms/SuggestionForm";


const data = [
  { id: 0, component: <ConsaltantForm />, isVisible: true },
  { id: 1, component: <ContactFrom />, isVisible: true },
  { id: 2, component: <RegistrationForm />, isVisible: true },
  { id: 3, component: <SuggestionForm />, isVisible: true },
];
...
export default function App() {
  ...
  return (
    <div className="container">
      <h3>👋 Hey We Here To Answer Any Question From You.
      </h3>
      <div className="btns-cont">
        <div
          style={{ backgroundColor: data[0].isVisible ? 'var(--prim3)' : '#eec342', display: 'flex', flexWrap: 'wrap'  }}
          onClick={() => {
            clickHandler(0);
          }}
          className="form-btn"
        ...
        <div
          style={{ backgroundColor: data[2].isVisible ? 'var(--prim3)' : '#eec342' }}
          onClick={() => {
            clickHandler(2);
          }}
          className="form-btn"
        >
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="#152040" d="M15 4a4 4 0 0 0-4 4a4 4 0 0 0 4 4a4 4 0 0 0 4-4a4 4 0 0 0-4-4m0 1.9a2.1 2.1 0 1 1 0 4.2A2.1 2.1 0 0 1 12.9 8A2.1 2.1 0 0 1 15 5.9M4 7v3H1v2h3v3h2v-3h3v-2H6V7H4m11 6c-2.67 0-8 1.33-8 4v3h16v-3c0-2.67-5.33-4-8-4m0 1.9c2.97 0 6.1 1.46 6.1 2.1v1.1H8.9V17c0-.64 3.1-2.1 6.1-2.1Z"/></svg>
          <br />
          Registration 
        </div>
        <div
          style={{ backgroundColor: data[3].isVisible ? 'var(--prim3)' : '#eec342' }}
          onClick={() => {
            clickHandler(3);
          }}
          className="form-btn"
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" stroke="#152040" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 21h6M12 3a6 6 0 0 0-5.019 9.29c.954 1.452 1.43 2.178 1.493 2.286c.55.965.449.625.518 1.734c.008.124.008.313.008.69a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1c0-.377 0-.566.008-.69c.07-1.11-.033-.769.518-1.734c.062-.108.54-.834 1.493-2.287A6 6 0 0 0 12 3Z"/></svg>
          <br />
          Suggestion
        </div>
      </div>
      <div id="forms" className="forms" style={{width: '80%'}}>
